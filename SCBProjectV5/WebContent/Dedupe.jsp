...
<div id="page">
	...
	<form method="post" name="dummy" class="register" action="DedupeServlet" style="margin-top: 60px" formvalidate="on" autocomplete="on"  autofocus="on">
		<center>
			<div class="w3-container w3-display-container w3-padding-16">
				<h3>DEDUPE CUSTOMER</h3>
					...
					<h7><label style="position: left; margin-left: 40px;"> First Name</label></h7>
                    	<input style="position: relative;  margin-bottom: 10px;" type="text" class="long" name="fname" placeholder="Name" pattern="[A-Za-z]{3,15}" /><br>
               		...
               		<h7><label style="position: left; margin-left: 20px;"> Middle Name</label></h7>
                    	...
                    	<input style="position: relative;  margin-bottom: 10px;" type="text" class="long" name="lname" placeholder="Name" pattern="[A-Za-z]{3,15}" /><br>
                		</div>		
					<h7><label style="position: left;"> Mobile Number</label></h7>
                    	<input style="position: relative;  margin-bottom: 10px;" type="tel" name="phno" placeholder="Mobile number" pattern="[0-9]{10}"  maxlength="10"  /><br>
                
					<h7><label style="position: left; margin-left: 76px;"> Email</label></h7>
                    	<input style="position: relative;  margin-bottom: 10px;" type="email" name="email" class="long" placeholder="abc@gmail.com" pattern="[A-Za-z0-9._\-]+@[A-Za-z0-9.\-]+\.[A-Za-z]{2,4}"  /><br>
               
					<h7><label style="position: left; margin-left: 4px;"> House Address</label></h7>
                    	<input style="position: relative;  margin-bottom: 10px;" type="text" name="address" placeholder="Address"  class="long" pattern="[A-Za-z0-9\s,-]*{3,20}" /><br> 
                
					<h7><label style="position: left; margin-left: 87px;"> City</label></h7>
                    	<input style="position: relative;  margin-bottom: 10px;" type="text" name="city" class="long" placeholder="City" pattern="[A-Za-z\s]{3,15}" /><br>
                <!-- city pattern="[A-Za-z\s,-]*{3,15} -->
					<h7><label style="position: left; margin-left: 95px;"> Pin</label></h7>
                    	<input style="position: relative;  margin-bottom: 10px;" type="text" name="pin" class="long" placeholder="Pin Code" pattern="[0-9]{6}" /><br>
                
                	<h7><label style="position: left; margin-left: -5px;"> Country</label></h7>
                  		<!--  <input type="text" name="country" class="long" placeholder="Country" pattern="[A-Za-z]" /><br>-->
                	...
                	<h7><label style="position: left; margin-left: 90px;"> Gender</label></h7>
                    	<input style="position: relative;  margin-bottom: 10px;" type="radio" name="gender" value="Male"   />
                    ...
                    <input style="position: relative;  margin-bottom: 10px;" class="year" type="text" size="4" maxlength="4" placeholder="1976 " pattern="[0-9]{4}" /><br>
                    ...
                    <select id="sele" onchange="removeall()" style="position: relative;  margin-bottom: 10px;" ng-model="myVar" name="pdoc" placeholder="Personal Document"  />
						<option value="">
               ...
               <h7><label style="position: left; margin-left: -12px;">Document ID No</label></h7>
                    <input name="sele2" id="testNo" style="position: relative;  margin-bottom: 10px;" type="text" class="long" name="name" placeholder="Doc ID" /><br>
			   			  
			   			   
			   </fieldset>
			<br>
				<p><button class="w3-button w3-block w3-green" onclick="execute()" value="Dedupe" type="submit" style="width:120px;text-align:center;">Dedupe &raquo;</button></p>
			<br><br><br>
